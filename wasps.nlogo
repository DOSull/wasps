__includes [ "setup.nls" "main.nls" "display.nls" "dispersal.nls" "adjust-counts.nls"]

extensions [ palette matrix vid gis ]
...
patches-own [
  capacity
  pops
  phase-pops      ; listed in N E S W core order, each a tuple of populations
  phase-next-pops
  r-loc
]
@#$#@#$#@
