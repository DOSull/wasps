...
to setup-kernel
  ...
  set kernel-weights map [ xy -> 1 / mean-d / exp (dist xy / mean-d) ] kernel-offsets
...
;  let d dist xy + (sqrt 2 + ln (1 + sqrt 2)) / 6
;  report 1 / mean-d / exp (d / mean-d)
;end
